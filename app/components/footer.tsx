      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="text-gray-200">
            <h1 className="anton text-xl lg:text-3xl">Khonam.id</h1>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 mt-3 lg:mt-0">
            <div>
              <h2 className="mb-3 text-xs md:text-sm font-semibold uppercase text-white">
                Contact
              </h2>
            ...
            <div>
              ...
              <div className="text-gray-500 text-xs md:text-md dark:text-gray-400 font-medium">
                <p className="mb-2">Pembuatan WebApp</p>
                <p className="mb-2">Pembuatan Website</p>
                <p>Pembuatan Toko Online</p>
              </div>
            </div>
            <div>
              <h2 className="mb-3 text-xs md:text-sm font-semibold uppercase text-white">
